...
var GUI = window.GUI || (function(){
  return {
    ...
    baseUI: function($this){
      ...
      $('#utilmenu li a').on('click', function(e){
        e.preventDefault();
        if (!$(this).closest('li').hasClass('on')) {
          $(this).closest('li').addClass('on');
          if ($(this).closest('li').hasClass('menu')) {
            $('.menu-wrap').addClass('on');
            $('.menu-dimm').show();
            $wrap.addClass('active-menu');
          }
          if ($(this).closest('li').hasClass('user')) {
            $('.ui-wrap').addClass('on');
          }
        } else {
      ...
      $('.menu-dimm').on('click', function(){
        $('.menu-wrap').removeClass('on');
        $('#utilmenu li.menu').removeClass('on');
        $('.menu-dimm').hide();
        $wrap.removeClass('active-menu');
      });
      ...
      $('.menu-list > li dt').on('click', function(){
        if (!$(this).closest('li').hasClass('has-menu')) {
          return;
        }
        if (!$(this).closest('li').hasClass('on')) {
      ...
      _.on('click', function(e){
        ...
        // if (!$(e.target).closest('#utilmenu, .menu-wrap').length) {
        //   $('#wrap').removeClass('active-menu')
        //   $('#utilmenu li.menu, .menu-wrap').removeClass('on');
        // }
      });
    },
    gnbMenu: function(){
